...
class KetenfoMetadataRepository
{
    /**
     * @var CachedDoctrineMetadataRepository
     */
    private CachedDoctrineMetadataRepository $repository;

    /**
     * @var IdentityProviderFactory
     */
    private IdentityProviderFactory $idpFactory;
    ...
    private function convertIdentityProviders(
        ...
        foreach ($idps as $idp) {
            ...
            $collection->add($this->idpFactory->createKetenfoIdentityProviderEntityFromEntity($idp));
        }
        return $collection;
    }
}
